...
class TestRemittanceofTDScertificate(FrappeTestCase):
	...
	def test_unpack_TC_B_227(self, mock_unzip_file):
		...
		with patch('erpnext_india.erpnext_india.doctype.remittance_of_tds_certificate.remittance_of_tds_certificate.get_email_list') as mock_get_email_list, \
			patch('erpnext_india.erpnext_india.doctype.remittance_of_tds_certificate.remittance_of_tds_certificate.create_attachment') as mock_create_attachment, \
